...
@section('content')
    <main>
        ...
        <div class="categories-tax-service-section">
            <div class="container">
                <h2>Browse “Location ways Tax Prepare”</h2>
                <p class="categori-heading-para">
                    Showing 12 Results for <a href="#">Personal Tax Preparation</a>
                </p>
                <div class="explore-card-filter-wrapper">
                    <div class="rating-filter">
                        <select>
                            <option data-display="Select">Select Rating</option>
                    ...
                    <div class="price-filter">
                        <select>
                            <option data-display="Select">Select Price</option>
                ...
                <div class="categories-tax-card-wrapper">
                    <div class="explore-tax-single-card">
                        <div style="background-image: url('{{asset('front_end/assets/images/explore-img.jpg')}} ')" class="explore-card-img-are">
                        </div>
                        ...
                        <div class="explore-card-heading-para">
                            ...
                            <p class="explore-card-location">
                                <img src="assets/images/location-icon.svg" alt="" srcset="" />
                                New York, NY
                            </p>
