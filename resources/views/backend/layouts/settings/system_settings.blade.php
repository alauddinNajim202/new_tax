                ...
                <div class="card-body">
                    <form method="post" action="{{ route('system.update') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('map') is-invalid @enderror" id="map" name="map"
                                placeholder="Google Map" value="{{ old('map', $setting->map ?? '') }}">
                            @error('map')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="hidden" name="remove_logo" value="0">
                                <input type="file" class="dropify @error('footer_logo') is-invalid @enderror"
